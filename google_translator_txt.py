...
def translate_txt(fn, src, dest):
    fn_docx = txt_to_docx(fn)
    return translate_docx(fn_docx, src, dest)
...
def translate(fn, src, dest):
    ...
    if post == 'txt':
        return translate_txt(fn, src, dest)
...
class Window(QtWidgets.QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Google文档翻译——Developed by hanshiqiang（微信公众号）")
        self.resize(800, 600)
